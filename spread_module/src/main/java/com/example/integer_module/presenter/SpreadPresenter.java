...
public class SpreadPresenter extends MVPBasePresenter<SpreadContract.IView>
    ...
    public void initData(String integral_type) {
        ...
        mModel.initSpreadRecord(userBean.getUser_id(), integral_type, new OnGetInfoListener<BaseBean<List<SpreadRecordBean>>>() {
            @Override
    ...
    public void loadMoreData(String integral_type) {
        ...
        mModel.loadMoreSpreadRecord(userBean.getUser_id(), integral_type, sale_share_id, new OnGetInfoListener<BaseBean<List<SpreadRecordBean>>>() {
            @Override
            public void onComplete() {
