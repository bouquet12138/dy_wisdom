...
import com.example.integer_module.fragment.RedeemFragment;
...
public class RedeemActivity extends MVPBaseActivity {
    ...
    private void initFragment() {
        mFragments.add(new RedeemFragment(SaleShareRecordBean.INTEGRAL_TYPE_DIRECT));//直推
        mFragments.add(new RedeemFragment(SaleShareRecordBean.INTEGRAL_TYPE_INDIRECT));//间推
        mFragments.add(new RedeemFragment(SaleShareRecordBean.INTEGRAL_TYPE_BUY));//买套餐
        mFragments.add(new RedeemFragment(SaleShareRecordBean.INTEGRAL_TYPE_REGISTER));//注册用户

        mFragments.add(new RedeemFragment(SaleShareRecordBean.INTEGRAL_TYPE_TOP));//充值
        mFragments.add(new RedeemFragment(SaleShareRecordBean.INTEGRAL_TYPE_TRAN));//互转
        mFragments.add(new RedeemFragment(SaleShareRecordBean.INTEGRAL_TYPE_WITHDRAW));//提现
