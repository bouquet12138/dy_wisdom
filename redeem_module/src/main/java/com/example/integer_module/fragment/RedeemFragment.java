...
import com.example.integer_module.adapter.RedeemAdapter;
import com.example.integer_module.base.MVPQMUIFragment;
import com.example.integer_module.contract.RedeemContract;
import com.example.integer_module.presenter.RedeemPresenter;
 ...
 */
public class RedeemFragment extends MVPQMUIFragment implements RedeemContract.IView {
    ...
    protected int getContentViewId() {
        return R.layout.sale_fragment_share;
    }
    ...
    public void refreshSaleShareList(List<SaleShareRecordBean> saleShareRecordBeans) {
        if (mAdapter == null) {
            mAdapter = new RedeemAdapter(saleShareRecordBeans);
