...
public class SaleSharePresenter extends MVPBasePresenter<SaleShareContract.IView>
    ...
    public void initData() {
        ...
        mModel.initSaleShareRecord(userBean.getUser_id(), getView().getType(), new OnGetInfoListener<BaseBean<List<SaleShareRecordBean>>>() {
            @Override
    ...
    public void loadMoreData() {
        ...
        mModel.loadMoreSaleShareRecord(userBean.getUser_id(), getView().getType(), sale_share_id, new OnGetInfoListener<BaseBean<List<SaleShareRecordBean>>>() {
            @Override
            public void onComplete() {
